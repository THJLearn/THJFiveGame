...
-(void)setUpGame:(NSString *)name block:(void (^)(BOOL))finish{
    ...
    if (_peripheralManager==nil) {
        //FEB9FE25-F33C-43CE-B012-7717D29788BB
        //29573686-2585-4309-8208-B45F59AB0330
        //初始化服务
         _ser= [[CBMutableService alloc]initWithType:[CBUUID UUIDWithString:[SvUDIDTools UDID]] primary:YES];
        //初始化特征
        _readChara = [[CBMutableCharacteristic alloc]initWithType:[CBUUID UUIDWithString:[SvUDIDTools UDID]] properties:CBCharacteristicPropertyNotify value:nil permissions:CBAttributePermissionsReadable];
        _writeChara = [[CBMutableCharacteristic alloc]initWithType:[CBUUID UUIDWithString:@"FEB9FE25-F33C-43CE-B012-7717D29788BB"] properties:CBCharacteristicPropertyWriteWithoutResponse value:nil permissions:CBAttributePermissionsWriteable];
        //向服务中添加特征
