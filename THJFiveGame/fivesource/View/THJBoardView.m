...
- (void)handleTap:(UITapGestureRecognizer *)tapGestureRecognizer {
    ...
    THJPoint point = [self findPointWithLocation:location];
    [self.delegate THJboardView:self didTapOnPoint:point];
...
//- (void)removeImageForMove:(THJMove *)move {
...
- (void)drawRect:(CGRect)rect {
    UIImage *background = [UIImage imageNamed:@"board"];
